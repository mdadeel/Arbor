...
async function main() {
  ...
  console.log(`  scores: overall=${report.scores.overall} arch=${report.scores.architecture} debt=${report.scores.techDebt} perf=${report.scores.performance} docs=${report.scores.documentation} sec=${report.scores.security}`)
